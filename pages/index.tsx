  ...
  return (
    <div className={styles.container}>
      <Head>
        ...
        <meta name="description" content="AI-powered human fall detection with real-time video streaming." />
      ...
      <header className={styles.header}>
        ...
        <nav>
          ...
          <a
            ...
            onClick={e => {
              e.preventDefault();
              document.getElementById('safety-tips')?.scrollIntoView({ behavior: 'smooth' });
            }}
          >
            Blog
          </a>
        ...
        >
          ...
          >
            <button
              ...
              onClick={() => setFeaturesOpen(false)}
            >×</button>
            <h2 style={{ marginBottom: '1.2rem', color: '#18382b' }}>Application Features</h2>
            <table style={{
              width: '100%',
              ...
              <tbody>
                <tr>
                  <td style={{
                    ...
                    <span className="material-symbols-outlined" style={{verticalAlign: 'middle', marginRight: 8}}>accessibility_new</span>
                  ...
                  <td style={{
                    ...
                    Detects human falls instantly using AI-powered video analysis.
                  </td>
                </tr>
                <tr>
                  <td style={{
                    ...
                    <span className="material-symbols-outlined" style={{verticalAlign: 'middle', marginRight: 8}}>videocam</span>
                ...
                <tr>
                  <td style={{
                    ...
                    <span className="material-symbols-outlined" style={{verticalAlign: 'middle', marginRight: 8}}>notification_important</span>
                    Instant Alerts
                  </td>
                  <td style={{
                    padding: '0.5rem',
                    ...
                    Sends immediate notifications to caregivers or staff when a fall is detected.
                  </td>
                </tr>
                <tr>
                  <td style={{
                    ...
                    <span className="material-symbols-outlined" style={{verticalAlign: 'middle', marginRight: 8}}>lock</span>
                    Privacy Protection
                  </td>
                  <td style={{
                    padding: '0.5rem',
                ...
                <tr>
                  <td style={{
                    ...
                    <span className="material-symbols-outlined" style={{verticalAlign: 'middle', marginRight: 8}}>monitoring</span>
                    Analytics Dashboard
                  </td>
                  <td style={{
                    padding: '0.5rem',
                    ...
                    Provides insights and statistics on fall incidents and response times.
                  </td>
                </tr>
                <tr>
                  <td style={{
                    ...
                    <span className="material-symbols-outlined" style={{verticalAlign: 'middle', marginRight: 8}}>devices</span>
        ...
        >
          ...
          >
            <button
              ...
              onClick={() => setWebcamOpen(false)}
            >×</button>
            <h2 style={{ marginBottom: '1.2rem', color: '#18382b' }}>Live Demo</h2>
            <video
              ref={webcamRef}
              autoPlay
              playsInline
            ...
            <div style={{ color: '#888', fontSize: '0.98rem' }}>
              Your webcam stream is only visible to you and not uploaded.
            </div>
          </div>
        </div>
      )}
      <main>
        <section className={styles.hero}>
          <div>
            ...
            <p>Real-time safety monitoring using AI and video streaming. Protect your loved ones and ensure rapid response to falls.</p>
            <button
              className={styles.cta}
              onClick={() => setWebcamOpen(true)}
            >
        ...
        <section className={styles.trusted}>
          ...
          <div className={styles.logos}>
            ...
            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ8GeTr4PU0yQ6DIRb_FieQ_phiYdetSeFsDQ&s" alt="Company 1" />
            {/* Company 2 logo updated */}
            <img src="https://www.cliniquelesoliviers.net/sites/all/themes/zayatine/skins/img/logo-zayatine-fr.svg" alt="Company 2" />
            {/* Company 3 logo updated */}
            <img src="https://www.clinique-elyosr-maternite.com/assets/img/groupe-el-yosr.png" alt="Company 3" />
          </div>
        </section>
        <Advice />
      ...
      <div className={`${styles.chatPanel} ${chatOpen ? styles.chatPanelOpen : ''}`}>
        ...
        <div className={styles.chatPanelBody}>
          {chatMessages.map((msg, idx) => (
            <div
              ...
              style={msg.from === 'user' ? { background: '#dbeee2', textAlign: 'right' } : {}}
            >
        ...
        >
          <input
            ...
            disabled={loading}
          />
          <button className={styles.chatPanelSend} type="submit" disabled={loading}>
            Send
          </button>
        </form>
      </div>
